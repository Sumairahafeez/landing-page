...
function Card() {
  return (
    <div className='w-screen h-full  bg-white m-auto flex mobile:w-screen'>
      ...
      <div className='w-[30%] h-[80%] relative top-24 -left-60 shadow-slate-500 shadow-xl rounded-md bg-tertiary flex flex-col justify-center items-center gap-10'>
        ...
        <img width="26" height="26" src="https://img.icons8.com/ios-filled/50/737373/linkedin.png" alt="linkedin"/>
        ...
        <img width="26" height="26" src="https://img.icons8.com/ios-filled/50/737373/youtube-play.png" alt="youtube-play"/>
        <img width="26" height="26" src="https://img.icons8.com/ios-filled/50/737373/discord--v1.png" alt="discord--v1"/>
        </div>
      </div>
      <div className='w-[40%] h-[90%] flex flex-col relative -left-56 justify-center gap-3'> 
        ...
        <div className='w-[50%] h-[6%] flex justify-center items-center gap-3 font-Laila mt-5'>
          <button className='w-[50%] h-full bg-secondary rounded-3xl'>RESUME</button>
          <button className='w-[50%] h-full border border-secondary rounded-3xl'>Projects</button>
        </div>
      </div>
    </div>
  )
